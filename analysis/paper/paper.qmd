...
```Hristijan Talevski imase predavanje nassss```

Here is a citation [@Marwick2017]

Here is an example @srbinovski1979
...
#| fig-cap: Scatter plot of miles per galon by horsepower

library(ggplot2) # you may need to install.packages("ggplot2")
ggplot(mtcars) +
   aes(mpg, hp) +
   geom_point()
...
Now I writing about the figure... in @fig-mtcars-scatter-plot
